...
`transports`, `reservations`, `inspirations` y `notes`. `schema_migrations` registra cada cambio aplicado.
...
y entidades. Se cancela si PostgreSQL ya contiene usuarios y valida todos los recuentos en una única transacción.
