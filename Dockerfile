...
CMD ["deno", "run", "--cached-only", "--allow-net=0.0.0.0:4173", "--allow-read=/app", "--allow-write=/app/data", "--allow-env=PORT,TABI_DATABASE_PATH,TABI_GOOGLE_MAPS_API_KEY,TABI_GOOGLE_MAPS_MAP_ID,TABI_PUBLIC_ORIGIN,TABI_SECURE_COOKIE", "server.js"]
