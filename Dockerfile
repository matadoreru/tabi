...
CMD ["deno", "run", "--cached-only", "--allow-net=0.0.0.0:4173,postgres:5432,maps.app.goo.gl:443,places.googleapis.com:443,api.frankfurter.dev:443", "--allow-read=/app", "--allow-env=PORT,TABI_METRICS_TOKEN,TABI_POSTGRES_HOST,TABI_POSTGRES_PORT,TABI_POSTGRES_DB,TABI_POSTGRES_USER,TABI_POSTGRES_PASSWORD,TABI_POSTGRES_POOL_SIZE,TABI_GOOGLE_MAPS_API_KEY,TABI_GOOGLE_PLACES_API_KEY,TABI_GOOGLE_MAPS_MAP_ID,TABI_PUBLIC_ORIGIN,TABI_SECURE_COOKIE,TABI_COMMIT_SHA,PGHOST,PGPORT,PGDATABASE,PGUSER,PGUSERNAME,PGPASSWORD,PGSSLMODE,PGMAX,PGSSL,PGIDLE_TIMEOUT,PGCONNECT_TIMEOUT,PGMAX_LIFETIME,PGMAX_PIPELINE,PGBACKOFF,PGKEEP_ALIVE,PGPREPARE,PGDEBUG,PGFETCH_TYPES,PGPUBLICATIONS,PGTARGET_SESSION_ATTRS,PGTARGETSESSIONATTRS,PGAPPNAME", "server.js"]
